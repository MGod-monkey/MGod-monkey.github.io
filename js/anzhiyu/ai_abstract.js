(function () {
  ...
  function introduce() {
    if (mode == "tianli") {
      startAI("我是MGodmonkey世界的MOSS，点击下方的按钮，让我生成本文简介、推荐相关文章等。");
    } else {
  ...
  function onAiTagClick() {
    if (mode === "tianli") {
      ...
      startAI(
        "你好，我是MGodmonkey世界MOSS，是一个基于GPT-4的生成式AI。我在这里只负责摘要的预生成和显示，你无法与我直接沟通，如果你也需要一个这样的AI摘要接口，可以在下方购买。"
      );
    } else {
  ...
  function changeShowMode() {
    ...
    if (mode === "tianli") {
      document.getElementById("ai-tag").innerHTML = "MGodのGPT";
